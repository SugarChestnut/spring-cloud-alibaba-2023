...
public abstract class AbstractObject {
        ...
        try {
            ...
            for (Field thisField : thisFields) {
                ...
                if (!Collection.class.isAssignableFrom(thisField.getType())) {
                    ...
                    try {
                        if (!(thisField.getType().getDeclaredConstructor().newInstance() instanceof AbstractObject)) {
                            continue;
                        }
                    } catch (Exception e) {
                    ...
                    Collection<Object> list = (Collection<Object>) thisField.get(this);
                    ...
                    if (targetField != null) {
                        ...
                        Collection<Object> clonedList = (Collection<Object>) thisField.get(this).getClass().getDeclaredConstructor().newInstance();
     ...
     */
    private void cloneList(Collection<Object> sourceList, Collection<Object> targetList, Class<?> cloneTargetClazz, CloneDirection cloneDirection) {
